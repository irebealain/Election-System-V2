      ...
      {showScrollButtons && (
        <>
          <button
            onClick={scrollLeft}
            className={cn(
              "absolute left-0 top-1/2 z-10 -translate-y-1/2 h-8 w-8 flex items-center justify-center bg-background text-foreground rounded-full shadow-md",
          ...
          <button
            onClick={scrollRight}
            className={cn(
              "absolute right-0 top-1/2 z-10 -translate-y-1/2 h-8 w-8 flex items-center justify-center bg-background text-foreground rounded-full shadow-md",
